...
def main():
    ...
    st.image("realistic-vector-icon-illustration-teeth-whitening-concept-dental-clinic-white-dirty-tooth.png", use_column_width=True)  # Replace with your main image path
